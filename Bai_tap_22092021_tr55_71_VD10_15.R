...
#Kiem dinh Wilcoxon cho cac bien so theo cap (wi?cox.test)
...
#tinh ?o phan tram, chung ta su dung ham prop.table
...
#Kie? dinh ti le (proportion test, prop.test, binom.test)
#VD 13
...
#VD 15
age <- c(46,20,52,30,57,25,28,?6,22,43,57,33,22,63,40,48,28,49)
