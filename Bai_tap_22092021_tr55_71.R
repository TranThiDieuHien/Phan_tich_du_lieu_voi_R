...
#Kiem dinh t hai mau
#VD 11
#xem xet muc do khac biet trung binh giua hai nhom va do l?ch chuan cua do
#khac biet.
...
#Chu y neu chung ta phan tich sai bang kiem dinh thong ke cho hai nho? doc lap duoi day
...
#Tan so (frequency)
#Ham table cho chu?g ta biet ve tan so cua mot bien so
...
#VD 13
#1: 621, 2: 713, vay ti le 1 ?a 0.4655 -> kiem dinh xem ti le nay co that su khac voi ti le 0.5 hay khong
...
bmi <- c(25.4,20.6,26.2,22.6,25.4,23.1,22.7,24.9,19.8,25.3,23.2,
         21.8,20.9,26.7,26.4, 1.2,21.2,22.8)
