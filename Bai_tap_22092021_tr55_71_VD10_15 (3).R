...
#Kiem dinh Wilcoxon cho hai mau (wil?ox.test)
...
#VD 13
#1: 621, 2: 713, vay ti l? 1 la 0.4655 -> kiem dinh xem ti le nay co that su khac voi ti le 0.5 hay khong
...
#So san? hai ti le (prop.test, binom.test)
#VD 14
...
#Kiem dinh Fisher ((Fisher's exact test, fish?r.test)
...
bmi <-c(25.4,20.6,26.2,22.6,25.4,23.1,22.7,24.9,19.8,25.3,23.2,
        21.8,20.9,26.7,2?.4,21.2,21.2,22.8)
